...
namespace FC.Codeflix.Catalog.UniTests.Application.Category.UpdateCategory
{
    ...
    public class UpdateCategoryTest
    {
        ...
        [MemberData(nameof(UpdateCategoryDataGenerator.GetCategotyToUpdate),
            parameters: 10, MemberType = typeof(UpdateCategoryDataGenerator))]
        public async Task UpdateCategory(DomainEntity.Category exampleCategory, UpdateCategoryInput input)
        {
            var _repositoryMock = _fixture.GetRepositoryMock();
            var _unitOfWorkMock = _fixture.GetUnitOfWorkMock();

            _repositoryMock.Setup(x => x.Get(exampleCategory.Id,
        ...
        public async Task ThrowWhenCategoryNotFound()
        {
            ...
            _repositoryMock.Setup(x => x.Get(input.Id,
                It.IsAny<CancellationToken>())
        ...
        [MemberData(nameof(UpdateCategoryDataGenerator.GetInvalidInputs),
                    parameters: 12, MemberType = typeof(UpdateCategoryDataGenerator))]
